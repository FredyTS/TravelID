    ...
    <div className="container-shell flex min-h-screen items-center justify-center py-16">
      <Card className="w-full max-w-xl border-white/70 bg-white/90 shadow-2xl shadow-slate-950/10">
        <CardHeader className="space-y-5">
          <AppLogo />
          <CardTitle className="text-3xl">Revisa tu correo</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 text-slate-600">
          ...
          <p className="text-sm text-slate-500">
            Si no aparece en tu bandeja principal, revisa spam o promociones y solicita el acceso otra vez desde la pantalla de login.
          </p>
        </CardContent>
      </Card>
    </div>
